                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-2 bg-amber-50 border border-amber-200 rounded-lg p-3">
                      ...
                      <div className="text-sm text-amber-800 font-medium">
                        ...
                        <span className="block text-xs font-normal mt-0.5">Ranked by photo match, best first.</span>
                      </div>
                    </div>
                        ...
                        <div key={p.id} className="flex items-center gap-3 border border-border rounded-lg p-2.5">
                          ...
                          >
                            <span className="text-sm min-w-0">
                              ...
                              <span className="block text-xs text-muted-foreground font-mono">SKU {p.sku}</span>
                            </span>
                            {resolving === p.id ? (
                              <Loader2 className="w-4 h-4 animate-spin shrink-0" />
                            ) : typeof p.confidence === "number" ? (
                              <span className="text-sm font-medium text-blue-700 shrink-0">{Math.round(p.confidence)}%</span>
                            ) : null}
                          </button>
                        </div>
                      ))}
